  ...
  return (
    <main className="min-h-screen" style={{ backgroundColor: 'var(--background)' }}>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        {/* Header */}
        <div className="mb-8">
          <Link href="/admin/templates" className="text-sm" style={{ color: 'var(--primary)' }}>
            ← Back to Templates
          </Link>
          <h1 className="text-4xl font-bold mt-2" style={{ color: 'var(--foreground)' }}>
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Civilian Relationship"
                  className="w-full border rounded px-2 py-1 text-sm"
                  style={{
                    backgroundColor: 'var(--background)',
                    borderColor: 'var(--border)',
          ...
          <div className="flex gap-4">
            ...
            <Link
              ...
              className="flex-1 px-4 py-2 rounded-lg font-semibold text-center transition-colors"
              style={{
