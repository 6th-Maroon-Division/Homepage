...
export default function ThemeSettings() {
  ...
  // Initialize custom theme data from customTheme prop
  ...
  useEffect(() => {
    if (customTheme && !showCustomEditor) {
  ...
  const handleSubmitForReview = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert('Theme submitted for review!');
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            ...
            <button
              ...
              style={{
                borderColor: theme === null ? 'var(--primary)' : 'var(--border)',
                backgroundColor: theme === null ? 'var(--primary)' : 'var(--background)',
                color: theme === null ? 'var(--primary-foreground)' : 'var(--foreground)'
              }}
            >
              <div className="font-bold">✓ System Default</div>
              <div className="text-xs mt-1" style={{ 
                color: theme === null ? 'var(--primary-foreground)' : 'var(--muted-foreground)',
                opacity: theme === null ? 0.9 : 1
              }}>
            ...
            <div className="mt-4 p-4 border rounded-lg space-y-4" style={{ borderColor: 'var(--border)' }}>
              ...
              {submissionStatus === 'form' && (
                <div className="mt-4 p-4 border rounded-lg space-y-3" style={{ borderColor: 'var(--primary)' }}>
                  <h3 className="font-medium" style={{ color: 'var(--foreground)' }}>Submit Theme for Public Review</h3>
